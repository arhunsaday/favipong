...
class FaviPong {
    ...
    handleMessage(message) {
        switch (message.type) {
            ...
            case 'gameStarted':
                ...
                this.updateGameStatus('Game started! Use W/S or ↑/↓ to move your paddle');
                break;
    ...
    updateFavicon() {
        ...
        this.ctx.fillRect(Math.round(this.gameState.ball.x), Math.round(this.gameState.ball.y), 1, 1);
